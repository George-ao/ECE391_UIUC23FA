cmd_/workdir/mp2_yuyiao2/module/tuxctl-ld.o := gcc -m32 -Wp,-MD,/workdir/mp2_yuyiao2/module/.tuxctl-ld.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.1.2/include -D__KERNEL__ -Iinclude -Iinclude2 -I/workdirmain/work/source/linux-2.6.22.5/include -include include/linux/autoconf.h  -I/workdir/mp2_yuyiao2/module -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -pipe -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -mtune=pentium2 -mtune=generic -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -I/workdirmain/work/source/linux-2.6.22.5/include/asm-i386/mach-default -Iinclude/asm-i386/mach-default -fomit-frame-pointer -g -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(tuxctl_ld)"  -D"KBUILD_MODNAME=KBUILD_STR(tuxctl)" -c -o /workdir/mp2_yuyiao2/module/.tmp_tuxctl-ld.o /workdir/mp2_yuyiao2/module/tuxctl-ld.c

deps_/workdir/mp2_yuyiao2/module/tuxctl-ld.o := \
  /workdir/mp2_yuyiao2/module/tuxctl-ld.c \
...
/workdir/mp2_yuyiao2/module/tuxctl-ld.o: $(deps_/workdir/mp2_yuyiao2/module/tuxctl-ld.o)
